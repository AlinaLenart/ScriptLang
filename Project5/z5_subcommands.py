...
import sys
import re
from z5_random_station import find_random_station, calculate_stats
...
def subcommand_random(args):
    ...
    name, address = find_random_station(args.compound, args.frequency, args.start, args.end)
...
def subcommand_stats(args):
    ...
    avg, stdev = calculate_stats(args.station, args.compound, args.frequency, args.start, args.end)
    if avg and stdev:
